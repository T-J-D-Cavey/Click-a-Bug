export function BugOne() {
// Currently not being used, should delete if it doesn't get used:
    return (
      <div className='BugOne'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="#89209E" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#84EB00" className="w-6 h-6 twitch">
            ...
            3.416.914 5.223 1.082M19.08 6c.205 1.08.337 2.187.392 3.314a23.882 23.882 0 01-5.223 1.082" />
        </svg>
      </div>
